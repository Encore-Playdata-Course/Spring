...
public class step03SessionTracking {
	 ...
	 * SessionAttributes()로 "cust" 별칭 등록
	 * Model 객체에 addAttributes("cust", Customer객체)
	 * view 단 : ${sessionScope.cust.id} 사용
	 * 
	 * Model API - request 또는 session 모두에서 사용
	 */
	//<a href="sessiontracking/sessionTest3DTO?id=mg&age=20">
